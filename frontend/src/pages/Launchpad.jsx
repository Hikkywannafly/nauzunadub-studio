...
export default function Launchpad({
  ...
  return (
    <div className="launchpad">
        ...
        <div className="lp-hero__row">
          <div className="lp-hero__col">
            ...
            <h1 className="lp-hero__title">
              ...
              Dub videos in <em>any voice, any language</em>.
              <span className="lp-hero__sweep" aria-hidden="true" />
            </h1>
            <p>
              Paste a YouTube link hoặc kéo file MP4 — transcribe → translate → re-voice → export.
              Hỗ trợ <span className="lp-pill">{t('common.languages_count')}</span> ngôn ngữ. Toàn bộ chạy local.
            </p>
          </div>
          <button
      ...
      {/* Action Cards — VideoDub Studio: Dub là flow chính, Clone để quản lý voice profile */}
      <div className="lp-actions">
        <ActionCard hue="#fe8019" Icon={Film} title="Dub Video" accent="🎬" count={studioProjects.length} onClick={() => setMode('dub')}>
          YouTube URL hoặc file MP4 → transcribe → translate → re-voice → export
        </ActionCard>
        <ActionCard hue="#d3869b" Icon={Fingerprint} title="Voice Library" accent="🎙" count={cloneProfiles.length} onClick={() => setMode('clone')}>
          Quản lý voice profile để gán cho speaker khi dubbing
        </ActionCard>
      </div>
